...
INSERT INTO tracks (
    ...
    (1, 1,  99, 'XXL', 'Anamorphosee', 1995, 260.388571, 44100, 0, 0, 0, NULL, '/Users/mickael/Music/Mylène Farmer - XXL.flac', 19, TRUE),
...
-- row 121 (hour=0 min=0 sec=0 canvas=0) is a catch-all sentinel; template_id NULL
